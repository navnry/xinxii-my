		...
		<view 
			...
			<view 
				...
				<view class="downwarp-content">
					<view v-if="isDownLoading" class="downwarp-progress"> 
						<view class="loading">
							<text></text>
							<text></text>
							<text></text>
					...
					<view v-else-if="downEndSuccess" class="downwarp-progress">
						<view class="loading">
							<text></text>
							<text></text>
							<text></text>
					...
					<view v-else-if="downEndFail" class="downwarp-progress">
						<view class="loading">
							<text></text>
							<text></text>
							<text></text>
					...
					<view v-else class="downwarp-arrow" :class="{rotate:downRotate}"></view>
			...
			<view 
				v-if="mescroll.optUp.use && downLoadType !== 3" 
...
<!-- #ifdef MP-WEIXIN || MP-QQ || APP-PLUS || H5 -->
<script src="@/common/libs/mescroll-uni/wxs/wxs.wxs" module="wxsBiz" lang="wxs"></script>
<!-- #endif -->

<!-- app, h5使用renderjs -->
<!-- #ifdef APP-PLUS || H5 -->
<script module="renderBiz" lang="renderjs">
	import renderBiz from '@/common/libs/mescroll-uni/wxs/renderjs.js';
	export default {
		mixins: [renderBiz]
	}
</script>
...
<script>
	import MeScroll from '@/common/libs/mescroll-uni/mescroll-uni.js';
	import MescrollEmpty from '@/common/libs/mescroll-uni/components/mescroll-empty.vue';
	import MescrollTop from '@/common/libs/mescroll-uni/components/mescroll-top.vue';
	import WxsMixin from '@/common/libs/mescroll-uni/wxs/mixins.js';
	import GlobalOption from './b-refresh-option.js';
	...
	export default {
		...
		computed: {
			...
			downEndSuccess() {
				return this.mescroll.isDownEndSuccess === true
			},
			downEndFail() {
				return this.mescroll.isDownEndSuccess === false
			},
		},
		methods: {
...
<style>
	@import "@/common/libs/mescroll-uni/mescroll-uni.css";
	@import "@/common/libs/mescroll-uni/components/mescroll-down.css";
	@import "./b-refresh.css";
</style>
